...
const projects: Project[] = [
  {
    ...
    logo: CourseClutch,
    description: "Automated course enrollment tracker with 7,000+ courses, used by 80,000+ students, deployed on AWS.",
    className: "cc",
  ...
  },
  {
    ...
    logo: WatAI,
    description: "Developing a machine learning model for TTC delay prediction, analyzing 34M+ data points across 300+ routes.",
    className: "watai",
    link: "https://watai.ca/#/",
  ...
  },
  {
    ...
    time: "Feburary 2025",
    logo: Minimax,
    description: "AI-powered Connect 4 bot with a 95%-win rate, using Minimax with Alpha-Beta pruning on 50,000+ game states",
    className: "minimax",
  ...
  },
  {
    ...
    time: "January 2025",
    logo: DocGen,
    description: "Google Gemini-powered document pipeline generating formatted outputs in under 5 seconds with 90% accuracy.",
    className: "clai",
    link: "",
